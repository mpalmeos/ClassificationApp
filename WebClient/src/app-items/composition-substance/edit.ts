...
export var log = LogManager.getLogger('CompositionSubstance.Edit');

@autoinject
export class Edit {

  private compositionSubstance : ICompositionSubstance | null = null;
  ...
  submit():void{
    ...
    this.compositionSubstanceService.put(this.compositionSubstance!).then(
      response => {
